...
class Units
{
     ...
     * @return float
     */
    public static function pctToPercentage($pct = 5000)
    {
        return round($pct * 100 / self::PCT_TO_PERCENTAGE, 2);
    }
    ...
    /**
     * Convert twip to pixel
     *
     * @param int $twip
     * @return int
     */
    public static function TwipToPixel($twip = 1)
    {
        return round($twip / self::INCH_TO_TWIP * self::INCH_TO_PIXEL);
    }
    ...
    {
        return round($point / self::INCH_TO_POINT * self::INCH_TO_PIXEL);
    }
